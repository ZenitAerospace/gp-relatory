...
\begin{figure}[H]
    ...
    \label{processo}
    \includegraphics[keepaspectratio=true,scale=0.8,angle=90]{figuras/processo.eps}
\end{figure}
...
\begin{table}[H]
    ...
    \begin{figure}[H]
        ...
        \includegraphics[keepaspectratio=true,scale=0.8]{figuras/processoHistorias.eps}
    \end{figure}
    ...
    \begin{figure}[H]
        ...
        \includegraphics[keepaspectratio=true,scale=0.8]{figuras/processoExecutar.eps}
    \end{figure}
